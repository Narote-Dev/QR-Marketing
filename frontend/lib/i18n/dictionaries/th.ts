...
export const th: Dictionary = {
  ...
  generator: {
    ...
    intro:
      "เลือกประเภท กรอกรายละเอียด ปรับดีไซน์ แล้วดาวน์โหลดภาพตัวอย่างแบบรวม ไม่มีการบันทึกข้อมูลใดๆ",
  ...
  seo: {
    generator: {
      ...
      description:
        "สร้างคิวอาร์โค้ดฟรี ไม่ต้องสมัคร สร้างโค้ดแบบสแตติกสำหรับ URL WiFi vCard WhatsApp LINE เมนู และอื่นๆ ปรับแต่งแล้วดาวน์โหลดได้ทันทีในเบราว์เซอร์",
