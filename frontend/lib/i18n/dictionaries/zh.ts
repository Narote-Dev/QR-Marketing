...
export const zh: Dictionary = {
  ...
  seo: {
    ...
    qr: {
      url: {
        title: "网址二维码生成器 — 可印刷链接码",
        description:
          "免费创建网址二维码，适用于菜单、活动与海报。含印刷尺寸、扫码技巧、静态与动态对比，以及仅在浏览器下载 — 无需注册。",
        h1: "为任意网址创建二维码",
        introduction:
          "将网址变成可扫描的二维码，让人们无需输入长链接即可打开页面。适用于海报、包装、名片、活动标识和纸质菜单 — 打印前务必试扫。",
        body: [
          "粘贴可在手机上快速打开的完整 https:// 地址。短而稳定的链接比带大量参数的追踪链接更容易扫成功。",
          "印刷时二维码边长至少 25–30 mm（约 2.5–3 cm），四边各留约 5 mm 空白，方便相机锁定码区。",
          "按真实观看距离试扫 — 海报常需 50–100 cm，桌牌约 25–40 cm。扫失败就放大码或提高纠错级别，再批量印刷。",
          "静态网址码直接编码链接：我们这边不会过期，但印刷后无法改目标。若网址变更，请重新下载 PNG，或在需要印刷后编辑时使用动态二维码。",
          "添加简短边框文案，如 Visit website、Scan for menu，或中文 访问网站 / 扫码看菜单，让人知道扫码后会发生什么。",
          "静态码全程在浏览器完成 — 我们不会存储你输入的网址。在光面纸上印刷时请保持高对比（浅底深点）。",
        ],
        howTo: [
          "粘贴完整网站地址，包含 https://。",
          "自定义颜色、边框文字与尺寸；印刷请保持强对比。",
          "下载 PNG，并按实际尺寸与距离试扫。",
          "手机扫码成功后再印刷或覆膜。",
        ],
        faqs: [
          {
            question: "这个二维码会过期吗？",
            answer: "不会。只要目标网站仍可在同一地址访问，静态网址二维码就会持续有效。",
          },
          {
            question: "之后还能更改跳转目标吗？",
            answer:
              "静态码印刷后无法更改。若需要可编辑短链，请在生成器切换到 Dynamic 模式，或打开动态二维码指南。",
          },
          {
            question: "印刷尺寸多大合适？",
            answer:
              "传单与名片上二维码本身至少 25–30 mm。更大的海报需要按比例放大，方便远处扫码。",
          },
          {
            question: "你们会存储我输入的网址吗？",
            answer:
              "静态网址码不会。创建与下载在浏览器完成。动态二维码不同 — 短链会保存，以便登录后编辑目标。",
          },
        ],
      },
      wifi: {
        title: "WiFi 二维码生成器 — 访客网络卡片",
        description:
          "免费创建咖啡馆与酒店用的 WiFi 二维码。密码仅在浏览器处理，含印刷尺寸、WPA 提示与访客/员工网络建议 — 无需注册。",
        h1: "用二维码分享 WiFi 接入",
        introduction:
          "让访客扫码连网，无需阅读或输入密码。适合咖啡馆柜台、酒店房卡与前台 — 静态码的凭证仅在浏览器处理。",
        body: [
          "按手机列表中的名称精确输入 SSID，包括大小写与空格。Cafe_Guest 与 cafe_guest 不同 — 名称不匹配是 WiFi 码失败的最常见原因。",
          "现代路由器选 WPA/WPA2。仅在你有意开放的网络选“无密码”。密码编入二维码载荷，请把印刷码当作共享密钥对待。",
          "静态 WiFi 创建完全在浏览器完成。我们不会上传、存储或记录网络名称或密码到服务器。",
          "约 50 mm 宽的柜台贴纸或 A6 卡片（105 × 148 mm）效果较好。二维码至少 25 mm 见方并留白，覆膜前站在柜台处试扫。",
          "印刷码请优先使用专用访客 SSID。不要把员工或管理密码印在公开桌牌上。",
          "蒸汽、反光与咖啡机旁的玻璃可能挡住码角 — 尽量哑光印刷，摆好后再试扫一次。",
        ],
        howTo: [
          "按已连接手机上显示的名称准确输入 WiFi 网络名。",
          "选择 WPA（或匹配的安全类型），需要时输入访客密码。",
          "设置简短边框文案，如 Connect to WiFi 或 连接 WiFi。",
          "下载并打印柜台尺寸样张，确认 iPhone 与 Android 都能加入网络。",
        ],
        faqs: [
          {
            question: "二维码会暴露我的 WiFi 密码吗？",
            answer:
              "会 — 能扫描或拍摄该码的人都可以从载荷读出密码。仅与允许接入该网络的人分享印刷码。",
          },
          {
            question: "你们会存储我的 WiFi 密码吗？",
            answer:
              "不会。静态 WiFi 二维码仅在浏览器生成。本应用不会将密码保存或传输到我们的服务器。",
          },
          {
            question: "应选择哪种安全类型？",
            answer:
              "大多数访客网络使用 WPA 或 WPA2。仅对旧路由器选 WEP，对有意开放的网络选无密码。",
          },
          {
            question: "咖啡馆柜台用多大尺寸？",
            answer:
              "50 mm 贴纸或 A6 卡片对大多数柜台已足够。二维码至少 25 mm 见方，覆膜前务必试扫。",
          },
        ],
      },
      email: {
      ...
      vcard: {
        title: "vCard 二维码生成器 — 电子名片",
        description:
          "免费创建含姓名、电话、邮箱与网站的 vCard 二维码。名片与胸牌印刷尺寸、保存联系人技巧，以及仅在浏览器下载。",
        h1: "用二维码分享电子名片",
        introduction:
          "vCard 二维码让对方一扫即可添加你的联系方式。印在名片、胸牌或展位标识上，无需反复输入电话和邮箱。",
        body: [
          "至少填写名或姓。仅添加你希望保存的组织、电话、邮箱和网站 — 信息更短的卡片在旧手机上往往更容易扫成功。",
          "大多数设备支持 vCard 3.0，但保存界面因相机应用与系统而异。订印名片前务必在 iPhone 与 Android 上试扫。",
          "名片上二维码至少 20–25 mm 见方并留白。胸牌与展位海报建议 30 mm 以上，方便一臂距离扫码。",
          "这是静态码：电话或邮箱变更后必须重新创建并印刷新 PNG。动态二维码用于可编辑的网页链接，不能在印刷后改写 vCard 载荷。",
          "使用简短边框文案，如 Save contact、Add me，或中文 保存联系人 / 电子名片，让人知道扫码是添加联系人而非打开网站。",
          "生成在浏览器完成。我们不会存储你为静态 vCard 下载所输入的联系字段。",
        ],
        howTo: [
          "至少填写名或姓作为名片内容。",
          "按需添加组织、电话、邮箱和网站。",
          "设置简短边框文案，并下载适合名片或胸牌尺寸的 PNG。",
          "在 iPhone 与 Android 上试扫，确认手机会提示保存联系人。",
        ],
        faqs: [
          {
            question: "每部手机保存联系人的方式都一样吗？",
            answer:
              "大多数手机支持 vCard 3.0，但保存界面会因设备和相机应用而异。请在客户实际使用的手机上测试。",
          },
          {
            question: "打印后还能更新信息吗？",
          ...
          },
          {
            question: "名片上的二维码应多大？",
            answer:
              "至少 20–25 mm 见方并留白。过小的码在室内柔光下经常扫失败。",
          },
          {
            question: "你们会存储我的电话或邮箱吗？",
            answer: "静态 vCard 码不会。字段留在浏览器中，直到你下载图片。",
          },
        ],
      },
      whatsapp: {
      ...
      line: {
        title: "LINE 二维码生成器 — 官方账号标识",
        description:
          "用 @官方账号、LINE ID 或 line.me 链接免费创建 LINE 二维码。含贴纸与柜台尺寸、加好友流程提示 — 美化标识，不替代 LINE OA Manager。",
        h1: "用二维码打开 LINE 主页",
        introduction:
          "LINE 在泰国和东亚广泛使用。编码官方账号（@handle）、LINE ID 或完整 line.me 链接，让扫码者无需输入 ID 即可添加聊天 — 再为柜台设计可印刷标识。",
        body: [
          "粘贴你已从 LINE OA Manager 复制的加好友链接或 @官方账号。本工具用该链接设计可印刷二维码；不替代 LINE 自带的 OA Manager 或分析功能。",
          "常见印刷尺寸：50 × 50 mm 柜台贴纸、A6 桌牌（105 × 148 mm）或小票底部。二维码至少 25 mm 见方并留白。",
          "设置顾客能看懂的短边框文案：Add LINE、添加 LINE、通过 LINE 下单 或 Chat with us。用已安装 LINE 的手机试扫。",
          "打开 LINE 主页需要扫码手机已安装 LINE。未安装时，扫码可能只显示网页回退，视设备而定。",
          "需要时把 LINE 柜台贴纸与菜单或 WiFi 二维码分开 — 每个印刷码只做一件事，比拥挤海报更容易扫成功。",
          "静态 LINE 码在浏览器生成。若之后更改 OA 邀请链接，请下载并重印新的 PNG。",
        ],
        howTo: [
          "输入 @官方账号、LINE ID，或粘贴来自 OA Manager 的完整 https://line.me 链接。",
          "选择模板或颜色，并设置简短中文或英文边框文案。",
          "下载适合 50 mm 贴纸或 A6 柜台桌牌的 PNG。",
          "在已安装 LINE 的情况下试扫，加好友流程成功后再印刷或覆膜。",
        ],
        faqs: [
          {
            question: "官方账号应填写什么？",
            answer: "使用 @handle 格式，例如 @yourshop，或粘贴来自 OA Manager 的官方邀请链接。",
          },
          {
            question: "扫码者需要安装 LINE 吗？",
            answer: "需要。打开 LINE 主页或加好友页要求扫码设备已安装 LINE 应用。",
          },
          {
            question: "这会替代 LINE OA Manager 吗？",
            answer:
              "不会。请在 LINE 工具中创建并管理官方账号，再把加好友链接粘贴到这里，仅用于设计可印刷二维码标识。",
          },
          {
            question: "店铺柜台贴纸多大合适？",
            answer:
              "常见为 50 × 50 mm 贴纸与 A6 桌牌（105 × 148 mm）。二维码至少 25 mm 见方，覆膜前试扫。",
          },
        ],
      },
      "google-review": {
        title: "Google 评价二维码生成器 — 手机 + 边框",
        description:
          "在手机上免费创建带样式边框的 Google 评价二维码。Google 自带二维码多为纯码 — 在此添加“给我们评分”标签并印刷柜台贴纸。",
        h1: "用二维码收集 Google 评价",
        introduction:
          "把评价二维码放在小票、桌牌或结账柜台。顾客扫码即可打开 Google 评价页 — 可带店铺颜色与简短“给我们评分 / Rate us”文案，用手机浏览器即可创建。",
        body: [
          "从 Google 商家资料复制短评价链接或“请求评价”链接，再粘贴完整 https:// 到此处。二维码一扫即可打开该公开评分页。",
          "Google 自带下载的二维码通常是无样式、无行动号召的纯码。这里可设置边框、添加“给我们评分”或 Rate us，并在手机上下载后再印刷。",
          "约 50 × 50 mm 的柜台贴纸或小型 A6 桌牌效果较好。二维码至少 25 mm 见方并留白，放置处避免被小票或调料遮住边角。",
          "评价网址以静态码编码。若 Google 更改分享链接，请创建新 PNG — 或在需要印刷后改目标时使用动态二维码。",
          "在柜台用顾客实际使用的手机相机试扫。柔光与反光覆膜在码过小时会降低成功率。",
          "静态生成在浏览器完成。无需 Google 登录 — 你只需粘贴已拥有的公开评价链接。",
        ],
        howTo: [
          "从 Google 商家资料复制评价或地图分享链接。",
          "粘贴完整 https 链接，再选择颜色与简短“给我们评分”边框文案。",
          "在手机上下载，并按柜台距离试扫。",
          "确认评价页正确打开后再印刷贴纸或桌牌。",
        ],
        faqs: [
          ...
          {
            question: "与 Google 自带二维码有何不同？",
            answer:
              "评价链接目标相同，但可添加品牌色、边框与短文案，并在手机上创建或下载。Google 默认文件是无样式标签的纯二维码。",
          },
          {
            question: "这是动态二维码吗？",
            answer:
              "不是。评价网址直接编码在静态二维码中。链接变更后请创建新码，或查看动态二维码页面了解可编辑目标。",
          },
          {
            question: "结账柜台用多大尺寸？",
            answer: "50 × 50 mm 贴纸或 A6 桌牌。二维码至少 25 mm 见方，覆膜前试扫。",
          },
        ],
      },
      dynamic: {
