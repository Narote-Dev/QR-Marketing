...
export const legalZh: LegalDocuments = {
  "privacy-policy": {
    ...
    websiteLabel: "网站",
    updatedLabel: "最后更新",
    updatedDate: "2026年8月26日",
    sections: [
      {
        title: "1. 用于生成二维码的输入内容",
        paragraphs: [
          "您在生成器中输入的静态二维码内容（包括 URL、文本、WiFi、电子邮件、电话、短信、vCard 等）默认仅在浏览器中处理（客户端）。我们不会为无关目的将这些静态内容保存在服务器上。",
          "启用动态二维码后，我们会存储短码、您选择的目标 URL、可选名称，以及基础扫描元数据（如时间、粗略设备类型，以及边缘网络提供时的国家/地区），以便重定向与管理功能运行。动态 MVP 不要求账号，所有权依赖浏览器中的管理令牌。请勿分享该令牌。",
        ],
      },
      {
        title: "2. 自动收集的信息",
    ...
    sections: [
      {
        title: "1. 服务说明",
        paragraphs: [
          "本网站免费提供静态二维码生成服务，支持 URL、文本、WiFi、电子邮件、电话、短信、vCard、聊天链接等客户端内容，静态码无需注册。",
          "启用动态二维码后，您可通过管理令牌创建可编辑的 URL 重定向。动态目标必须是 http 或 https。您对所配置的目标及管理令牌的安全保管负责。",
        ],
      },
      {
        title: "2. 可接受的使用方式",
