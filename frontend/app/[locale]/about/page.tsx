...
export function generateStaticParams() {
  // Step 1: Pre-render the About page in every supported language.
...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return getCompanyMetadata(params.locale, "about");
}
...
export default async function AboutPage({ params }: Props) {
  ...
  const document = getCompanyDocument(locale, "about");
